...
fig.update_layout(width=1900,height=1000,margin=dict(l=50,r=50,b=40,t=60),yaxis=dict(range=[0,400000]),xaxis=dict(dtick=1, autorange=True),title=dict(font = dict(size=20)))
fig.update_layout(xaxis={'categoryorder':'total descending'})
fig.write_image("access-country-bar.png")

fig1 = px.bar(df, x = 'country', y = 'count' , title = 'fw-traffic')
fig1.update_layout(width=1900,height=1000,margin=dict(l=50,r=50,b=40,t=60),yaxis=dict(range=[0,20]),xaxis=dict(dtick=1, autorange=True),title=dict(font = dict(size=20)))
fig1.update_layout(xaxis={'categoryorder':'total descending'})
fig1.write_image("access-country-bar-mini.png")

fig2 = px.bar(df, x = 'country', y = 'count' , title = 'fw-traffic')
fig2.update_layout(width=1900,height=1000,margin=dict(l=50,r=50,b=40,t=60),yaxis=dict(range=[0,15000]),xaxis=dict(dtick=1, autorange=True),title=dict(font = dict(size=20)))
fig2.update_layout(xaxis={'categoryorder':'total descending'})
fig2.write_image("access-country-bar-middle-big.png")

fig3 = px.bar(df, x = 'country', y = 'count' , title = 'fw-traffic')
fig.update_layout(width=1900,height=1000,margin=dict(l=50,r=50,b=40,t=60),yaxis=dict(range=[0,5000]),xaxis=dict(dtick=1, autorange=True),title=dict(font = dict(size=20)))
fig3.update_layout(xaxis={'categoryorder':'total descending'})
fig3.write_image("access-country-bar-middle-middle.png")
